...
│   ├── rocket_launchpad_freestone.jpg # Ground-level view along airframe and launch rod at Freestone Park
│   ├── rocket_motor_mount_retained.jpg # Motor mount with dual #6 screw & 3/8" washer retention
│   ├── rocket_openrocket_model.png  # OpenRocket 1.60 cal static stability model
│   ├── rocket_payload_cad.png       # SolidWorks payload bay & shock cord anchor CAD
│   ├── rocket_pico_telemetry.jpg    # RP2040 MicroPython bench bring-up telemetry photo
│   ├── rocket_printed_parts.jpg     # Bambu Lab A1 3D-printed nose cone and bay
│   ├── rocket_recovery_touchdown.jpg # Full rocket recovered intact on grass after flight
│   ├── rocket_sim_comparison.png    # OpenRocket flight simulation comparison table (D12 vs F32)
│   ├── rocket_test_flight_1.mp4     # First test flight video from liftoff to touchdown
│   ├── rocket_trajectory_plot.png   # OpenRocket altitude & lateral drift curves vs time
